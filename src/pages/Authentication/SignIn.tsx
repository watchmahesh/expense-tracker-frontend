  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // Handle specific error messages if the response isn't successful
        toast.error('Login failed: ' + response.data.message || 'Unknown error', TOAST_CONFIG);
      }
    } catch (error ) {
      if (error instanceof AxiosError) {
        // Adjust to match the expected error response structure
        const errorMessage = (error.response?.data as { message?: string })?.message || 'An error occurred. Please try again.';
        toast.error(errorMessage, TOAST_CONFIG);
      } else {
        toast.error('An unexpected error occurred. Please try again.', TOAST_CONFIG);
      }
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-20">
               PLease Sign With Proper Creadentials
              </p>
